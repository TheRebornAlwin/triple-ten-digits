...
const Hero = () => {
  ...
  return (
    <section ref={heroRef} className="relative min-h-screen flex items-center justify-center bg-pure-black overflow-hidden">
      ...
      <div className="container mx-auto px-8 lg:px-20 max-w-7xl relative z-10">
        <div className="text-center space-y-16">
          ...
          <motion.h1
            ...
            className="relative"
          >
            <span className="block text-7xl md:text-8xl lg:text-9xl font-serif font-light text-white leading-[0.95] tracking-tight">
              We Don't Just
            </span>
            <span className="block text-7xl md:text-8xl lg:text-9xl font-serif font-light leading-[0.95] tracking-tight mt-4">
