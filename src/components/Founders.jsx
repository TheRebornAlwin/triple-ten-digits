...
const Founders = () => {
  ...
  return (
    <section id="about" ref={ref} className="relative py-12 sm:py-16 md:py-24 lg:py-32 overflow-hidden">
      <div className="absolute inset-0 bg-pure-black" />

      <div className="absolute top-1/4 left-0 w-[250px] md:w-[500px] h-[250px] md:h-[500px] bg-liquid-gold/5 rounded-full blur-3xl" />
      <div className="absolute bottom-1/4 right-0 w-[250px] md:w-[500px] h-[250px] md:h-[500px] bg-liquid-gold/5 rounded-full blur-3xl" />
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-20 max-w-6xl relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-3 px-4 sm:px-6 py-2 sm:py-3 rounded-full glass-dark border border-liquid-gold/30 mb-6 md:mb-8">
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-8 lg:gap-12 mb-10 md:mb-16">
          {founders.map((founder, index) => (
            ...
            >
              {/* Image container */}
              <div className="relative aspect-square rounded-2xl md:rounded-3xl overflow-hidden mb-4 md:mb-6 glass-card">
                <img
                  src={founder.image}
                  alt={founder.name}
                ...
                <div className="absolute inset-0 border-2 border-white/5 group-hover:border-liquid-gold/40 transition-all duration-500 rounded-2xl md:rounded-3xl" />
              </div>

              {/* Bio */}
              <p className="text-white/70 leading-relaxed font-light text-sm md:text-base lg:text-lg px-1 md:px-2">
                {founder.bio}
              </p>
            </motion.div>
          ))}
        ...
        <motion.div
          ...
          className="glass-card rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-12 border border-liquid-gold/20 text-center max-w-4xl mx-auto"
        >
          <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-serif font-light text-white leading-tight mb-3 md:mb-4">
            We're not your typical agency owners.
          </p>
          <p className="text-white/70 text-sm md:text-base lg:text-lg leading-relaxed max-w-2xl mx-auto">
            We've built businesses, failed, learned, and come back stronger. We know what it's like to pour everything into a business and watch marketing budgets disappear.
          </p>
        </motion.div>
      </div>
    </section>
